    ...
    <div className="w-full h-full fixed top-0 left-0 z-10 bg-headingColor bg-opacity-40">
      ...
      >
        ...
        <button
          ...
          className="w-[1.8rem] h-[1.8rem] bg-primaryColor text-white absolute top-[1.7rem] 
          right-[1.7rem] text-[25px] flex items-center justify-center rounded-[3px] leading-0
        cursor-pointer hover:bg-smallTextColor ease-in duration-300"
        >
          &times;
        </button>
      </div>
